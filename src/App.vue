...
<template>
  <div class="app">
    <div class="toolbar">
       <div class="menu">
        <span class="menu-icon" @click="openMenu('fileMenu')" @mouseover="openMenu('fileMenu')">
      ...
      <div class="menu">
        <span class="menu-icon" @click="openMenu('helpMenu')" @mouseover="openMenu('helpMenu')">
...
export default {
  ...
  methods: {
    ...
    closeMenus(e) {
      if(!Util.elementHasClass(e.target.parentNode, ['menu', 'menu-dropdown',"menu-icon"])){
        this._hideMenus();
      }
